...
const Contact = () => {
  return (
    <div className="h-auto pt-16 lg:pt-24 " id="contact">
      <p className="font-playfair text-4xl lg:text-8xl font-bold text-custom-white ml-24">
        CONTACT ME
      </p>
      <div className="flex flex-col justify-center items-center md:flex-row w-full gap-8 mt-16  px-4 md:px-16">
        <div className="md:w-1/2 flex flex-col items-center md:items-start">
          <div className="font-poppins font-medium text-base md:text-lg  text-[#D9D9D9] mb-6 md:w-4/5">
          ...
          <div className="font-poppins font-medium text-base mt-9 md:text-lg text-custom-green md:w-4/5">
      ...
      <FaLinkedin className="h-5/6 w-auto "/></a>
      <a href="https://github.com/Sanchi-0207" target="_blank">
      <FaGithub className="h-5/6 w-auto" /></a>
      </div>
      <div className="font-poppins text-base text-custom-black font-normal flex justify-center pb-1">
